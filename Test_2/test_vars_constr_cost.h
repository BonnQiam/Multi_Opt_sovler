...
namespace ifopt {
    ...
    class ExVariables : public VariableSet {
        ...
        public:
            ExVariables(const std::string& name, VectorXd& x) : VariableSet(Num_var, name){
            ...
            VecBound GetBounds() const override{
                ...
                bounds.at(0) = Bounds(0.0,10.0);
                bounds.at(1) = Bounds(0.0,10.0);
                bounds.at(2) = Bounds(1.0,5.0);
                bounds.at(3) = Bounds(0.0,6.0);
                bounds.at(4) = Bounds(1.0,5.0);
                bounds.at(5) = Bounds(0.0,10.0);
